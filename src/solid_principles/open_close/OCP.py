...
if __name__ == "__main__":
    ...
    customer_data_with_email = CustomerData(
        name="Jane Doe", contact_info=ContactInfo(email="jane@example.com")
    )

    customer_data_with_phone = CustomerData(
        name="Jane Doe", contact_info=ContactInfo(phone="0987654321")
    )

    payment_data = PaymentData(amount=100, source="tok_visa")
    payment_data_2 = PaymentData(amount=200, source="tok_mastercard")
    payment_data_3 = PaymentData(amount=300, source="tok_amex")

    payment_processor.process_transaction(customer_data_with_email, payment_data_2)
    payment_processor.process_transaction(customer_data_with_phone, payment_data_3)
